![Docker Pulls](https://img.shields.io/docker/pulls/aaron2397/jd_scripts?style=for-the-badge)
### Usage
```diff
...
+ 2021-02-21更新 https://gitee.com/lxk0301/jd_scripts 仓库被迫私有，老用户重新更新一下镜像：https://hub.docker.com/r/aaron2397/jd_scripts)(docker-compose.yml的REPO_URL记得修改)后续可同步更新jd_script仓库最新脚本
...
+ 例1:配置远程shell脚本, 我自己写了一个shell脚本https://raw.githubusercontent.com/Aaron-lv/someDockerfile/master/jd_scripts/shell_script_mod.sh 内容很简单下载惊喜农场并添加定时任务
+ CUSTOM_SHELL_FILE=https://raw.githubusercontent.com/Aaron-lv/someDockerfile/master/jd_scripts/shell_script_mod.sh
+
